...
class MyWindow(QMainWindow, form_class):
    def __init__(self):
        ...
        self.code_list = self.kiwoom.GetCodeListByMarket(0)
    ...
    def inquiry_balance(self):
        ...
        df = self.kiwoom.block_request("opw00001",
            계좌번호=self.accountComboBox.currentText(),
            비밀번호="",
            비밀번호입력매체구분="00",
            조회구분=2,
            output="예수금상세현황",
        ...
        #self.kiwoom.SetInputValue("비밀번호", "0712")
    ...
    def automatic_order(self):
        ...
        for i in range(cnt):
            ...
            if stocks[5].rstrip() == '매수전':
                self.kiwoom.SendOrder("자동매수주문", "0101", account, 1, code, int(qty), int(price), hoga_type_table[hoga], "")
            ...
            # 참고: 해당 종목을 현재도 보유하고 있다고 가정함.
                ...
                self.kiwoom.SendOrder("자동매도주문", "0101", account, 2, code, int(qty), 0, hoga_type_table[hoga], "")
                #print("order_no: ", self.kiwoom.order_no)
